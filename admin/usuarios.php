...
<table id="usuariosTable" class="table table-striped">
    ...
    <tbody>
        <?php
        $sqlUsuario = mysqli_query($conn, "SELECT * FROM usuario");
        ...
        while ($dd = mysqli_fetch_assoc($sqlUsuario)) {
            ...
            <tr>
                ...
                <td>
                    <a href='editar_usuario.php?id=<?php echo $dd['id'] ?>' class='btn btn-warning btn-sm'><i
                            class="bi bi-pencil-square"></i> Editar</a>
                    <a href='deletar_usuario.php?id=<?php echo $dd['id'] ?>' class='btn btn-danger btn-sm'><i
