    ...
    <div class="container mt-5">
        ...
        <form action="./includes/cadastrar_produto.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="descricao" name="descricao" rows="4" placeholder="Descrição do produto"></textarea>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-6 col-md-4 mb-3">
                    ...
                    <input type="number" class="form-control" id="preco_unitario" name="preco_unitario" step="0.01" placeholder="Digite o preço" required>
                </div>
                
                <div class="col-6 col-md-4 mb-3">
                    <label for="estoque_atual" class="form-label">Estoque Atual</label>
                    <input type="number" class="form-control" id="estoque_atual" name="estoque_atual" placeholder="Quantidade em estoque" required>
                </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" id="controlado_sim" name="tipo_controlado" value="1">
                    <label class="form-check-label" for="controlado_sim">Sim</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" id="controlado_nao" name="tipo_controlado" value="0" checked>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="registro_anvisa" name="registro_anvisa" placeholder="Digite o registro ANVISA">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="estoque_minimo" name="estoque_minimo" placeholder="Digite o estoque mínimo">
            </div>
